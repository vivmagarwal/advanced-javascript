// Dummy Promises for Practice; Each function returns a promise
...
export const promiseCondition = {
  ALWAYS_RESOLVE: "always resolve",
  ALWAYS_REJECT: "alwyas reject",
  RANDOM: "random"
};

export function fetchRandomNumber(forceResolution = promiseCondition.RANDOM) {
  let randomNumber;

  switch (forceResolution) {
    case promiseCondition.ALWAYS_RESOLVE:
      randomNumber = 0.75;
      break;
    case promiseCondition.ALWAYS_REJECT:
      randomNumber = 0.25;
      break;
    default:
